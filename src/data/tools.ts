...
export const tools: Tool[] = [
  ...
  { id: 'stage-profile', title: '賽段剖面圖', titleEn: 'Stage Profile', description: '上傳 GPX／FIT／TCX 生成環法風剖面圖，爬坡自動分級。', descriptionEn: 'Tour-style profile from your GPX / FIT / TCX with auto-categorized climbs.', category: '單車', path: '/tools/stage-profile', icon: '⛰️', status: 'available', keywords: ['gpx', 'fit', 'tcx', 'profile', '剖面圖', '爬坡', 'climb', 'hc', '海拔', 'strava', '路線', '公路車', 'bike'] },
