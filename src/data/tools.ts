...
export const tools: Tool[] = [
  ...
  { id: 'everyday-calc', title: '生活計算', titleEn: 'Everyday Calc', description: 'BMI、百分比、折扣、小費分帳。', descriptionEn: 'BMI, percentages, discounts and tip splitting.', category: '計算', path: '/tools/everyday-calc', icon: '🧾', status: 'available', keywords: ['bmi', '百分比', '折扣', '小費', 'tip', 'discount', 'percent'] },
